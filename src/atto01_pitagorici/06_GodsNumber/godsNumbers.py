...
class GodsNumbers(Scene):
    def construct(self):
        cube2 = ImageMobject("../../assets/imgs/rubiks-cube2x2.png").scale(0.5).to_edge(LEFT)
        mosse2 = Tex(r"2x2 \\ 11 mosse").next_to(cube2, DOWN)

        cube3 = ImageMobject("../../assets/imgs/rubiks-cube3x3.jpg").move_to(ORIGIN)
        mosse3 = Tex(r"3x3 \\ 20 mosse").next_to(cube3, DOWN)

        cube4 = ImageMobject("../../assets/imgs/rubiks-cube4x4.jpg").scale(0.5).to_edge(RIGHT)
