...
class PerfectNumbers(MovingCameraScene):
    def construct(self):
        numbers = VGroup(
            BoheldText("6", font_size=50),
            BoheldText("28", font_size=50),
            BoheldText("496", font_size=50),
            ...
            BoheldText("2.658.455.991.569.831.744.654.692.615.953.842.176", font_size=100),
