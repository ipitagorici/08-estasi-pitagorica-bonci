...
class PerfectNumbers(MovingCameraScene):
    def construct(self):
        ...
        numbers = VGroup(
            VGroup(BoheldText("6", font_size=50), pitagorici.copy()).arrange_in_grid(rows=2),
            VGroup(BoheldText("28", font_size=50), pitagorici.copy()).arrange_in_grid(rows=2),
            VGroup(BoheldText("496", font_size=50), pitagorici.copy()).arrange_in_grid(rows=2),
            BoheldText("8.128", font_size=70),
            BoheldText("33.550.336", font_size=70),
            BoheldText("8.589.869.056", font_size=70),
            BoheldText("137.438.691.328", font_size=100),
            BoheldText("2.305.843.008.139.952.128", font_size=100),
            VGroup(BoheldText("2.658.455.991.569.831.744.654.692.615.953.842.176", font_size=100), eulero.copy().scale(3.25)).arrange_in_grid(rows=2, buff=LARGE_BUFF),
